    ...
    <main class="flex w-100 flex-col min-h-screen">
                ...
                <div class="flex justify-between md:flex-none items-center">
                    <inertia-link href="/" class="py-2 md:py-0">
                        <div class="flex items-center">
                            ...
                            <span class="font-bold text-gray-700 text-xl ml-2"
                                >Grab Your Event</span
                            >
                        </div>
                    </inertia-link>
                        ...
                        <dropdown>
                            <template #trigger>
                                <div class="flex items-center">
                                    ...
                                    >
                                        {{ $page.auth.user.name.charAt(0) }}
                                    </div>
                                    <div class="text-left ml-2">
                                        <span
                                            class="text-sm leading-tight block w-32 truncate"
                                            >{{ $page.auth.user.name }}</span
                                        >
                                        <span
                            ...
                            <template #dropdown>
                                ...
                                >
                                    ...
                                    <div
                                        class="border-t my-1 border-gray-200"
                                    ></div>
        ...
        <div class="px-4 lg:px-6 py-16" style="background: #26385D">
            <div class="container mx-auto">
                ...
                <div
                    class="pt-8 border-t border-blue-900 text-sm md:flex md:justify-between"
                >
