<template>
    <card
        class="w-full mb-4 rounded-lg hover:shadow-md relative"
        :is-padding="false"
    ...
    >
        ...
        <div class="p-4">
            ...
            <span
                class="w-24 text-center truncate px-1 mt-4 mr-2 absolute top-0 right-0 md:hidden bg-orange-100 text-orange-600 rounded-full text-xs inline-block uppercase tracking-wide font-semibold"
                >{{ event.event_category }}</span
            >

            <div class="flex mb-4 relative">
                <div class="pr-3 border-r-2 hidden md:block mr-3">
                    <heading size="heading">{{ event.event_date }}</heading>
                ...
                <div>
                    <heading
                        size="large"
                        tag="h2"
                        class="truncate block w-40 md:w-48 mt-4 md:mt-0"
                        >{{ event.event_name }}</heading
                    >
                    <div
                        class="text-gray-500 text-sm truncate block w-40 md:w-48"
                    >
            ...
            <div class="flex bg-white text-sm justify-between items-center">
                <heading
                    ...
                    class="font-semibold w-48 truncate"
                ></heading>
            </div>
        </div>
    </card>
