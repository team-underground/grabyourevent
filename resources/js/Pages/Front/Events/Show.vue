                ...
                <card :is-padding="false" class="mb-10">
                    <div class="md:flex md:flex-wrap relative">
                        ...
                        >
                            ...
                            <div
                                class="flex bg-gray-100 md:bg-transparent mt-10 px-8 md:px-12 py-4 md:py-6"
                            >
                                <template
                                    v-if="event.event_ticket_price == 'Free'"
                                >
                                    <heading size="large" class="font-serif"
                                        >Free</heading
                                    >
                                </template>
                                <template v-else>
                        ...
                        <div class="md:w-2/3 px-4">
                            <div class="md:pr-10">
                                ...
                                <div class="mb-10">
                                    ...
                                    >
                                    <heading
                                        v-html="event.optional_description"
                                    ></heading>

                                    <list
                                        :lists="event.what_is_included"
                                        unordered-list-color="text-orange-400"
                                        class="mt-4"
                                    ></list>
                                </div>
