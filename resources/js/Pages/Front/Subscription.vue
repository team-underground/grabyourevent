<template>
    <div
        class="relative bg-white py-8 md:py-16 overflow-hidden px-4"
        style="height:25rem;"
    >
        <div class="max-w-5xl mx-auto">
            <div class="-mx-4 md:flex">
                <div class="md:w-2/3 px-4">
                    <div class="md:pr-10">
                        <heading size="heading2" class="mb-2"
                        ...
                        <p class="md:w-2/3 text-xs mt-4 text-gray-500">
                            By subscribing you agree to the
                            <link-to to="/terms-of-services"
                                >Terms of Service
                            </link-to>
                            and
                            <link-to to="/privacy-policy"
                                >Privacy Policy</link-to
                            >. You also agree to recieve product related emails
                            from Grab Your Event, which you can unsubscribe from
                            at any time.
                        </p>
                    </div>
                </div>
