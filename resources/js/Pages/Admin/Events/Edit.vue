        ...
        <div class="bg-white px-4 pt-6 pb-4 relative shadow-sm z-20">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="md:flex items-center">
                    <div class="flex-1">
                        <heading size="heading" class="inline-flex mr-1"
                            >Edit Event #{{ event.event_id }}</heading
                        >
                        <badge
                            variant="success"
                        ...
                        <badge
                            variant="warning"
                            v-if="event.event_status === 'Moderation'"
                            >{{ event.event_status }}</badge
                        >
                    </div>
                    <div class="flex">
        ...
        <div class="py-10">
            <div class="max-w-6xl mx-auto">
                <div class="md:flex -mx-4">
                    <div class="px-4">
                        <alert class="mb-4">
                            <strong>Note:</strong> Event once created will go to
                            the admin first for moderation and then only will be
                            published on the website. It typically takes 24hrs
                            for the moderation process to get completed.
                        </alert>
                        <div class="md:flex mb-10 -mx-4">
                            <div class="md:w-1/3 mb-3 px-4">
                                ...
                                >
                                <heading class="mb-4"
                                    >This section contains the basic details of
                                    your event</heading
                                >
                            </div>
                            <div class="md:w-2/3 px-4">
                                <card>
                                    ...
                                    <simple-editor
                                        ...
                                        @keydown="
                                            delete errors['event_description']
                                        "
                                    ></simple-editor>
                                    <simple-editor
                        ...
                        <div class="md:flex -mx-4 mb-10">
                            <div class="md:w-1/3 px-4">
                                ...
                                >
                                <heading class="mb-4"
                                    >Details about where your event will be
                                    hosted.</heading
                                >
                                <alert
                                    >Search your event venue from the map to get
                                    started</alert
                                >
                            </div>
                            <div class="md:w-2/3 px-4">
