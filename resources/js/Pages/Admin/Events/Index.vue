        ...
        <div class="py-10 px-4">
            <div class="max-w-6xl mx-auto">
                <alert class="mb-4" v-if="events.data.length">
                    ...
                    the moderation process to get completed and then only will
                ...
                <div class="relative">
                            ...
                            <td class="border-t">
                                ...
                                >
                                    <badge
                                        variant="warning"
                                        v-if="
                                            data.event_status === 'Moderation'
                                        "
                                        >{{ data.event_status }}</badge
                                    >
                                    <badge
                                        variant="success"
                                        v-if="data.event_status === 'Published'"
                                        >{{ data.event_status }}</badge
                                    >
                                </span>
                            </td>
                    ...
                    <empty-state class="lg:py-32" v-else>
                        ...
                        <heading class="mt-5 mb-1" size="heading"
                            >No Events created by you</heading
                        >
