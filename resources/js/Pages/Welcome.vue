<template>
	<layout>
		<vue-glide class="px-4 py-4 md:hidden" :perView="1" :gap="20" :peek="{ before: 0, after: 80 }">
			<vue-glide-slide v-for="i in 3" :key="i">
				<event-mobile-card :event="advertised[i]" class="w-2/3 mb-0"></event-mobile-card>
			</vue-glide-slide>
		</vue-glide>
		...
		<div class="px-4 lg:px-6 pt-10 pb-10 bg-gray-100 hidden md:block">
			<div class="container mx-auto">
				...
				<div class="md:flex md:flex-wrap md:flex-1 -mx-4 mb-10">
					<div class="w-1/2 md:w-1/4 px-4" v-for="(event, idx2) in upcoming" :key="idx2">
						<event-card :event="event"></event-card>
					</div>
				</div>
			</div>
		...
		<div class="px-4 lg:px-6 py-8 md:py-20 bg-white">
			<div class="container mx-auto">
				<heading size="heading" class="mb-6 md:mb-10 text-left md:text-center">Browse by Categories</heading>
				<!-- <div
                    v-dragscroll
                    style="white-space: nowrap; overflow-x: hidden; overflow-y: hidden;"
				>-->
				...
				>
					<vue-glide-slide v-for="(category, idx) in categories" :key="idx">
						<!-- <div
						...
						>-->
						<div
							class="overflow-hidden shadow-md bg-orange-100 rounded-lg h-48 md:h-64 w-full items-center relative overlay-black"
						>
							<!-- <div
							...
							<div class="z-10 absolute left-0 right-0 bottom-0 mx-2 rounded-lg py-4">
								<span
				...
				<div class="-mx-4 flex">
					...
					<div class="w-4/5 relative px-4">
						<div class="flex items-center mb-4">
							<heading size="small-caps" class="text-orange-500 md:ml-10">Quote</heading>
							<div class="h-1 bg-orange-200 flex-1 ml-5"></div>
						</div>

						<div
							class="text-3xl md:text-5xl text-gray-700 font-semibold font-serif mb-1 md:ml-10 italic leading-tight"
