<template>
    <layout>
        ...
        <!-- featured events -->
        <div
            class="px-4 lg:px-6 md:pt-10 pb-10 bg-gray-100"
        ...
        >
            <div class="container mx-auto">
                ...
                <div class="flex flex-wrap md:flex-1 -mx-2 md:-mx-4">
                    <div
                        class="w-1/2 md:w-1/4 px-2 md:px-4 mb-2"
                    ...
                    >
                        ...
                        >
                            ...
                            <img
                                ...
                                "
                                src="/categories/entertainment.jpg"
                                alt
                                class="object-cover h-64 w-full block rounded-lg"
                            />
                            <img
                            ...
                            <div
                                class="z-10 absolute left-0 right-0 bottom-0 mx-2 rounded-lg py-4"
                            >
                                <span
