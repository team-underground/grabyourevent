        ...
        <div class="bg-white px-4 relative shadow-sm z-20">
            <div class="md:max-w-6xl mx-auto">
                <div class="flex flex-wrap md:justify-center">
                    <inertia-link
                        class="w-1/3 md:w-1/6 border-b md:border-transparent py-5 text-center px-4 flex flex-col hover:text-orange-600 items-center justify-center"
        ...
        <div class="py-10 px-4">
            <div class="max-w-6xl mx-auto">
                <template v-if="Object.keys(total_counts).length > 0">
                    <heading size="heading" class="mb-6"
                        >Page views Analytics</heading
                    >
                    <card class="mb-10">
                        <page-views
                            :total="total_counts"
                ...
                <heading size="heading" class="mb-6" v-if="events.length"
                    >Page Views</heading
                >

                <div class="relative mb-10">
                    <div
                        class="absolute fixed top-0 bottom-0 right-0 w-6 bg-white-linear rounded-r-lg opacity-75"
                    ></div>
                    <basic-table
                        :headings="headings"
                        v-if="events.length"
                        ...
                        >
                            ...
                            <td class="border-t">
                                <span
                                    ...
                                    >{{
                                        data.event_published_at_formatted
                                    }}</span
                                >
                            </td>
                            <td class="border-t">
